...
import { getAgent, updateAgent, deleteAgent, type Agent, type UpdateAgentRequest, type AgentToolConfig, getAgentWebhookUrl } from '@/lib/api/agents';
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <Switch
                      checked={formData.toolConfig?.enableToolCalling ?? false}
                      onCheckedChange={(checked) =>
                        setFormData({
                          ...formData,
                          toolConfig: {
                            ...formData.toolConfig,
                            enableToolCalling: checked,
                          },
                        })
                      }
                    />
                      ...
                      <div className="p-4 border rounded-lg bg-gray-50">
                        <div className="flex items-center justify-between">
                          ...
                          <Input
                            ...
                            max={50}
                            className="w-20"
                            value={formData.toolConfig?.maxIterations ?? 10}
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                toolConfig: {
